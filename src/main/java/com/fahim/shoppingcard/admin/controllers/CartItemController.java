...
import com.fahim.shoppingcard.admin.services.cart.ICartItemService;
import com.fahim.shoppingcard.admin.services.cart.ICartService;
...
@RestController
@RequestMapping("${api.prefix.admin}/cartItems")
public class CartItemController {
    ...
    public ResponseEntity<ApiResponse> addItemToCart(@RequestParam(required = false) Long cartId,
        ...
        try{
            if(cartId==null){
                cartService.initializedNewCart();
            }
